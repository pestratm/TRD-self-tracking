...
public:
    Ali_TRD_Photon() :
        vertex_point(),bit_TRD_layer_shared(-1),pT_AB(-1),AP_pT(-1),AP_alpha(-1),dca_min_xy(-1),dca_min_z(-1),dca_min(-1),path_min(-1),Inv_mass_AB(-1),Eta_AB(-1),Phi_AB(-1),
        dot_product_dir_vertex(-1),Inv_mass_AB_K0s(-1),dcaAB_xy(-1),dcaAB_z(-1),dcaAB(-1),Inv_mass_AB_Lambda(-1),Inv_mass_AB_antiLambda(-1),
	...
	~Ali_TRD_Photon() 
    {
        ...
        void set_dca_min(Float_t dca_z)                                {    dca_min_z = dca_z;                                                }
        ...
        void set_dcaAB(Float_t dca_ab_z)                                 {    dcaAB_z = dca_ab_z;                                                 }
        ...
        Float_t get_dca_min() const                                 {    return dca_min_z; }
        ...
        Float_t get_dcaAB() const                                {    return dcaAB_z; }
